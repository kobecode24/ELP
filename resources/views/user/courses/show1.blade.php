            ...
            <div
                ...
                <div class="w-full xl:w-3/5 grid space-y-5 lg:space-y-10 p-4 ml-0 xl:ml-5">
                    ...
                    <div class="block xl:hidden">
                        ...
                        <div class="w-full">
                            <form method="POST" action="{{ route('user.courses.enroll', $course->id) }}" style="width: 100%;" class="rounded-lg">
                                @csrf
                                <button
                        ...
                        <div class="hidden xl:block border shadow-lg">
                            ...
                            <div class="w-full">
                                <form method="POST" action="{{ route('user.courses.enroll', $course->id) }}" style="width: 100%;">
                                    @csrf
                                    <button
                                        class="w-full text-lg font-semibold text-white transition-all duration-300 bg-[#A435F0] hover:bg-purple-500 py-3 rounded-lg">
                                        Get now
                                    </button>
                                </form>
                                <div class="px-2 py-3 space-y-1">
